...
![](fig/introduction/AI_ML_DL_differences.png){alt='An infographic showing some of the relationships between AI, ML, and DL'}
...
![](fig/introduction/sklearn_input.png){alt='Types of Machine Learning'}
...
![](fig/introduction/ML_summary.png){alt='Types of Machine Learning'}
